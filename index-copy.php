...
/* check connection */
                    ...
                    <div class="column">
                        <h3 class="title is-3 has-text-centered">Proyectos</h3>
                        <hr>
                        <div class="content">
                            <ul>
                                <li><a href="./edicloud_web/">edicloud_web</a></li>
                                <li><a href="./edicloud-back-android/">edicloud-back-android</a></li>
                                <li><a href="./edicloud-bp-back-android/">edicloud-bp-back-android</a></li>
                                <li><a href="./edicloud-pb-web/">edicloud-pb-web</a></li>
                                <li><a href="./osorio_logistica/">osorio_lgistica</a></li>
